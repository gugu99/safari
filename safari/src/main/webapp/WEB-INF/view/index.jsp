                        ...
                        <div class="col-lg-12 col-md-12 col-12 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <h3 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Workspace Create</span></h3>
                                </div>
                                <div class="card-content">
                                    <div class="card-body pt-0">
                                        <form class="form-horizontal" action="${pageContext.request.contextPath }/addWorkspace" method="post">
                                            ...
                                            <button type="submit" class="btn btn-outline-primary btn-block"><i class="feather icon-unlock"></i>Create</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

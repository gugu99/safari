        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-4 col-12 mb-md-0 mb-2 mt-1">
                    <button class="btn btn-outline-primary ml-10" type="button" data-toggle="modal" data-target="#add-feedback"><i class="feather icon-plus icon-left"></i> 피드백 추가하기</button>
                </div>
            </div>
                        ...
                        <div class="card-content">
                        	 <div class="px-0 py-0 ml-1 mt-1 mb-2">
	                             ...
	                             <span class="fa fa-caret-right mr-1"></span>
	                              <!-- 피드백 받은사람 리스트 -->
                   	 			<div class="avatar avatar-offline bg-info m-0 mr-50"><span class="fa fa-user"></span></div>
                   	 			<span class="text-bold-600 mr-1">받은사람</span>
                   	 			<span class="blue-grey date ml-1">작성일</span>
                   	 			 <!-- 수정 삭제 버튼 -->
                            ...
                            <div class="card-footer px-0 py-0">
	                            <div class="card-content">
	                                 <div class="card-body">
	                                     <p class="card-text ml-1 mt-2 mb-3">내용</p>
	                                 </div>
	                            </div>
                            </div>
                        </div>

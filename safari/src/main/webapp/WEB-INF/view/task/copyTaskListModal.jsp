...
<!-- 업무 복사하기 modal 시작 -->
<div class="modal fade text-left" id="copyTaskListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel38" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel38">업무리스트 복사하기</label>

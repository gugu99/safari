	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="form-group">
					<label>프로젝트 선택</label>
					<select class="form-control text-dark" name="insertLowerTask" id="insertLowerTask">
						<!-- 프로젝트가 추가 된다. -->
					</select>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>하위업무 해제</label>
					<select class="form-control text-dark" name="deleteLowerTask" id="deleteLowerTask">
						<!-- 하위업무가 추가 된다. -->
					</select>
				</div>
			</div>
